/*
Errno::ENOENT: No such file or directory @ rb_sysopen - styleScss.scss

Backtrace:
C:/Ruby27-x64/lib/ruby/gems/2.7.0/gems/sass-3.7.4/lib/sass/plugin/compiler.rb:454:in `read'
C:/Ruby27-x64/lib/ruby/gems/2.7.0/gems/sass-3.7.4/lib/sass/plugin/compiler.rb:454:in `update_stylesheet'
...
body:before {
  ...
  content: "Errno::ENOENT: No such file or directory @ rb_sysopen - styleScss.scss"; }
